...
function App() {
  ...
  return (
    <>
      <div className="App">
        {registrationSuccess && (
          <div className='result' style={{ color:'white',padding: '10px',marginTop:'10px',borderRadius:'8px',textAlign:'center'}}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <br />
          {/* submit button  */}
          <button type='submit' style={{ color: 'white', padding: '10px', border: 'none', cursor: 'pointer' }}>Register</button>
        </form>
      </div>
    </>
  )
